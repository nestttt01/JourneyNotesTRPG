...
"NPC 好感滿值、關係破裂或死亡等重大節點，系統會自動記進 Flags 與冒險日誌。": ["Major beats like an NPC's affection maxing out, a relationship breaking, or a death are logged automatically into Flags and the adventure log.", "NPC の好感度満タン・関係決裂・死亡などの重要な節目は、自動で Flags と冒険日誌に記録されます。"],
