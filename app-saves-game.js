...
- 只有明確是消耗型補給的道具（如急救包、鎮靜劑、食物、藥劑）才可在 changes.item_effects 標效果，格式 {"道具名":{"type":"hp|san","amount":8-40}}，且該道具名必須同時出現在 items_add；多數道具不需標效果。回復由程式在玩家實際使用時執行，不要在敘事或 changes.hp/san 裡自行改動數值。
